  ...
  return (
    <div className="grid grid-cols-12 h-screen max-h-screen">
      <div className="col-span-3 h-screen flex flex-col justify-center items-center">
        <h2 className="text-5xl text-blue-500 pb-20">Bienvenido</h2>
      ...
      { search !== "" ? <div className="col-span-5 flex flex-col justify-center gap-1 overflow-y-scroll">
        ...
        <div className="col-span-5 flex flex-col justify-center">
          <h1 className="px-5 text-3xl text-blue-500">Ingresa un producto para buscar</h1>
        </div>
      }
    </div>
  );
